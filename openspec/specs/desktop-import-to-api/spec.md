# Desktop Import to API

## Purpose

Describes how the Desktop application uploads a selected local `data-bank.json` to the API `POST /api/import` endpoint from Remote mode, using upsert semantics to update the data bank.
